      ...
      <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-slate-800/30 via-slate-950 to-black animate-pulse"></div>
        ...
        <div className="relative z-10">
          ...
          <div className="container mx-auto px-8 py-16 text-white flex flex-col items-center">
            <h1 className="text-4xl font-bold mb-8 text-slate-200 text-center">Privacy Policy</h1>
            <div className="text-left max-w-3xl">
              ...
              <h2 className="text-2xl font-bold mb-4 text-slate-300">Information Collection And Use</h2>
              ...
              <h3 className="text-xl font-bold mb-2 text-slate-400">Types of Data Collected</h3>

              <h4 className="text-lg font-bold mb-2 text-slate-500">Personal Data</h4>
              ...
              <h4 className="text-lg font-bold mb-2 text-slate-500">Usage Data</h4>
              <p className="text-lg mb-4">We may also collect information how the Service is accessed and used ("Usage Data"). This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit, the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.</p>

              <h4 className="text-lg font-bold mb-2 text-slate-500">Tracking & Cookies Data</h4>
              ...
              <h2 className="text-2xl font-bold mb-4 text-slate-300">Transfer Of Data</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-slate-300">Security Of Data</h2>
              <p className="text-lg mb-4">The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>

              <h2 className="text-2xl font-bold mb-4 text-slate-300">Service Providers</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-slate-300">Links To Other Sites</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-slate-300">Children's Privacy</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-slate-300">Changes To This Privacy Policy</h2>
              ...
              <p className="text-lg">If you have any questions about this Privacy Policy, please contact us at legal@libreonix.in.</p>
            </div>
          </div>
          <Footer />
        </div>
