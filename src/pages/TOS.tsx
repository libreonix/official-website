      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 font-inter antialiased">
        ...
        <div className="relative z-10">
          ...
          <div className="container mx-auto px-8 py-16 text-white flex flex-col items-center">
            <h1 className="text-4xl font-bold mb-8 text-purple-400 text-center">Terms of Service</h1>
            <div className="text-left max-w-3xl">
              ...
              <h2 className="text-2xl font-bold mb-4 text-purple-300">Accounts</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-purple-300">Links To Other Web Sites</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-purple-300">Termination</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-purple-300">Disclaimer</h2>
              <p className="text-lg mb-4">Your use of the Service is at your sole risk. The Service is provided on an "AS IS" and "AS AVAILABLE" basis. The Service is provided without warranties of any kind, whether express or implied, including, but not limited to, implied warranties of merchantability, fitness for a particular purpose, non-infringement or course of performance.</p>

              <h2 className="text-2xl font-bold mb-4 text-purple-300">Governing Law</h2>
              ...
              <h2 className="text-2xl font-bold mb-4 text-purple-300">Changes</h2>
