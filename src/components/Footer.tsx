          ...
          <div className="flex justify-center space-x-6 mb-8">
            {[
              ...
              <a
                ...
                className="w-12 h-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl flex items-center justify-center text-white/60 hover:text-electric-blue hover:bg-white/10 hover:border-electric-blue/30 transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-electric-blue/20"
              >
                <social.icon />
              </a>
            ))}
